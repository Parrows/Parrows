...
As we have seen earlier, in its purest form, parallel computation (on functions) can be seen as the execution of some functions \code{a -> b} in parallel, \code{parEvalN} (Fig.~\ref{fig:parEvalN}):
