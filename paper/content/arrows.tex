...
\end{code}
\vfill
\caption{The definition of |Arrow| type class and its two most typical instances.}
...
\caption{Schematic depiction of Arrow (left) and its basic
...
\end{figure}
Hughes also defined some syntactic sugar (Fig.~\ref{fig:syntacticSugarArrows}): The combinators |second|, |***| and |&&&|. 
