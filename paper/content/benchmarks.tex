...
As the last Benchmark in this paper we present the \sudokutest in \ref{fig:sudokuSMBenchmark} running in a shared memory setting. Here we see all three SM backends performing similar again like in the \rmtest SM benchmarks. \mbcomment{Benchmarks seem a bit off. redo}
