...
\begin{subtable}[t]{.5\linewidth}%
	...
	\begin{tabular}{l R{1cm} R{1.3cm} R{1.3cm}}
		% \multicolumn{3}{c}{worst Sudoku Benchmarks} \\ \hline
		vs.             & cores	& params   & factor \\ \hline
		\csvreader[head to column names]{benchmarks/sudoku-sm/worstSudoku.csv}{}{\vs & \nCores & \params & \factor \\}
	\end{tabular}
	\endgroup
    \caption{Sudoku}\label{table1}
\end{subtable}
