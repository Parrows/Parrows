...
memory setting. All benchmarks were done on \enquote{the Glasgow GPG Beowulf cluster}, consisting of
...
The PArrows version of \rmtest on a single node of the Glasgow cluster
