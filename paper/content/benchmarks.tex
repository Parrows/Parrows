...
\newcommand{\performanceJacobiDistDiff}[6]{
\performancediffplot{Run time differences\\for \jacobitest \enquote{#2}}{(Eden $-$ PArrows)}{256}{#3}{
\addplot+[mark=*,very thick,error bars/.cd,
    y dir=both,y explicit] table [x="nCores", y="time", y error="max stddev", col sep=comma, mark=dots,
smooth]{benchmarks/distributed-jacobi/#1-#2-diff.csv};
\addplot+[mark=*,very thick,error bars/.cd,
    y dir=both,y explicit] table [x="nCores", y="time", y error="max stddev", col sep=comma, mark=dots,
smooth]{benchmarks/distributed-jacobi/#1-#6-diff.csv};
}{#4}{#5}{\plotwidthDist}
}
...
%\hfill%
{\performanceJacobiDistDiff{3}{3217}{32}{0.5}{272}{4253}\label{subfig:rm-dist-b}}
\caption{Parallel performance of \rmtest on the Glasgow grid
