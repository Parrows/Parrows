...
We will now discuss some benchmarks of our new PArrows DSL. We start by proving that we do not introduce any noteworthy 

\subsection{Comparison with Eden}
...
\subsection{Shared Memory Benchmarks}
