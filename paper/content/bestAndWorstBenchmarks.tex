...
\begin{tabular}{C{4cm} C{2cm} C{1.7cm} C{2.3cm} C{1.7cm}}
	\thead{Benchmark} & \thead{vs.}             & \thead{mean \\ overhead} & \thead{maximum \\ normalized \\ stdDev} & \thead{runtime for \\ 16 cores} \\ \hline \\
...
\begingroup\catcode`"=9
\begin{tabular}{C{4cm} C{2cm} C{1.7cm} C{2.3cm} C{1.7cm}}
	\thead{Benchmark} & \thead{vs.}             & \thead{mean \\ overhead} & \thead{maximum \\ normalized \\ stdDev} & \thead{runtime for \\ 256 cores} \\ \hline \\
