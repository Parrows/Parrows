...
\caption{Overhead in the shared memory benchmarks. Bold marks values
  in favour of PArrows. Overhead is unitless, multiply by 100 to
...
\begin{tabular}{C{4cm} C{2cm} C{1.7cm} C{2.3cm} C{1.7cm}}
	\thead{Benchmark} & \thead{Base}             & \thead{Mean of \\ mean \\overheads} & \thead{Maximum \\ normalized \\ stdDev} & \thead{Runtime for \\ 16 cores} \\ \hline \\
...
\begingroup\catcode`"=9
\begin{tabular}{C{4cm} C{2cm} C{1.7cm} C{2.3cm} C{1.7cm}}
	\thead{Benchmark} & \thead{Base}             & \thead{Mean of \\ mean \\overheads} & \thead{Maximum \\ normalized \\ stdDev} & \thead{Runtime for \\ 256 cores} \\ \hline \\
