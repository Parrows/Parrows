...
\label{fig:confa}
\end{figure}
To get our configurable \code{ArrowParallel} instance, we simply unwrap the strategy and pass it to \code{parList} like in the fully evaluating version (Fig.~\ref{fig:ArrowParallelMulticoreConfigurable}).
\begin{figure}[h]
\begin{lstlisting}[frame=htrbl]
instance (NFData b, ArrowApply arr, ArrowChoice arr) =>
