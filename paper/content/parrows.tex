...
Up until now we discussed Arrow operations more in detail, but in the following sections we focus on the dataflow instead of how the Arrows are obtained so we can focus on the important parts now that we have seen that Arrows are capable of expressing parallelism.