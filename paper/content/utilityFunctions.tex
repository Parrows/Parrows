...
In Fig.~\ref{fig:profunctorArrow} we show how specific Profunctors can be turned into Arrows.
...
%
We begin with warping Eden's build-in Futures in PArrows as in
