...
In Fig.~\ref{fig:profunctorArrow} we show how specific Profunctors can be turned into Arrows. Note that in Standard GHC |(>>>)| has the type |(>>>) :: Category cat => cat a b -> cat b c -> cat a c|.
...
\footnote{for additional information on the typeclasses see: \url{https://hackage.haskell.org/package/profunctors-5.2.1/docs/Data-Profunctor.html}}}
