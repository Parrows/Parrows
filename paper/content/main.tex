...
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{arr}\;(\Varid{const}\;[\mskip1.5mu \mskip1.5mu])\;\Varid{pipepipepipe}\;(\Varid{f}\mathbin{***}\Varid{mapArr}\;\Varid{f}\mathbin{>\!>\!>}\Varid{arr}\;(\Varid{uncurry}\;(\mathbin{:}))){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
...
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{arr}\;(\Varid{const}\;\Varid{b})\;\Varid{pipepipepipe}\;{}\<[E]%
\\
\>[9]{}\hsindent{8}{}\<[17]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}(\mathord{@}\Varid{pipepipepipe}\mathord{@})\mathbin{::}\Conid{ArrowChoice}\;\Varid{arr}\;\Varid{a}\;\Varid{c}\to \Varid{arr}\;\Varid{b}\;\Varid{c}\to \Varid{arr}\;(\Conid{Either}\;\Varid{a}\;\Varid{b})\;\Varid{c}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
