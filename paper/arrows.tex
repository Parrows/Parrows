...
\end{figure}
Arrows were introduced by \citet{HughesArrows} as a general interface for computation. An arrow \code{arr a b} represents  a computation that converts an input \code{a} to an output \code{b}. This is defined in the arrow typeclass:
...
\begin{minipage}{0.25\textwidth}
	...
	\subcaptionbox{composition \code{(>>>)}}{\includegraphics[scale=0.6]{images/compose}}
...
\begin{figure}
	...
	\end{tabular}
	\caption{Syntactic sugar for arrows. \olcomment{FIXME: subreferences? refer to the figure in text!}}
	\label{3}
\end{figure}
With this typeclass in place, Hughes also defined some syntactic sugar: The mirrored version of \code{first}, called \code{second},
\begin{lstlisting}[frame=htrbl]
