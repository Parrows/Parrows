...
\\\\
The Benchmarks were run on a Core i7-3970X CPU @ 3.5GHz with 6 cores and 12 threads. All versions were run 100 times. The resulting running-times were then averaged.
\\
\begin{tikzpicture}
\begin{axis}[
xbar, xmin=0,
