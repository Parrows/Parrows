...
\subsection{ParMonad}
The \code{Par} monad introduced by Marlow et al \cite{monad_par_paper}, which can be found in the monad-par package on hackage \cite{monad_par_hackage}, is a monad designed for composition of parallel programs.
\\\\
