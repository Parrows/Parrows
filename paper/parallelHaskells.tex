...
\olcomment{swap $f_i$ and $a_i$! add ``evaluation'' to the last set of arrows?}
...
\olcomment{add as figure? both code and image? reference then!}
\end{center}
...
%\\
a \code{spawnF} function that
%This 
allows us to define \code{parEvalN} directly:
